import { Binary, FileDown, MoveRight, Upload } from "lucide-react";
...
const steps: Step[] = [
    {
        ...
        label: 'Upload PDF',
        description: 'Unggah dokumen PDF kamu dengan mudah melalui fitur drag & drop atau tombol upload.'
    },
    {
        icon: <Binary size={64} strokeWidth={1.5}/>,
        label: 'Analisis AI',
        description: 'Biarkan AI kami memindai, memahami, dan menganalisis isi dokumenmu.'
    },
    {
        icon: <FileDown size={64} strokeWidth={1.5}/>,
        label: 'Dapatkan Rangkuman',
        description: 'Nikmati ringkasan singkat dan padat yang langsung siap kamu baca atau simpan.'
    }
];
        ...
        lg:px-8">
            ...
            >
                <div
                    ...
                    sm:left-[calc(50%+36rem)] sm:w-[72.1875]"
                    style={{
                        clipPath:
            ...
            <div className="text-center mb-16">
                    ...
                    <h3 className="font-bold text-3xl max-w-2xl mx-auto">
                        Ubah file PDF apapun menjadi sebuah ringkasan yang mudah dipahami 
                        dengan 3 langkah utama
                    </h3>
            </div>
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4 h-full">
        <div
          className="flex items-center justify-center h-24 w-24 mx-auto 
          rounded-2xl bg-linear-to-br from-rose-500/10 to-transparent 
          group-hover:from-rose-500/20 transition-colors"
        >
          <div className="text-rose-500 text-4xl">{icon}</div>
        </div>
